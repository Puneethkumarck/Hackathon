...
public class Product implements Item,Serializable{
    ...
    @JoinTable(name="ProductOffer", joinColumns=@JoinColumn(name="id", referencedColumnName="id"),
            inverseJoinColumns=@JoinColumn(name="offerid", referencedColumnName="offerid"))
